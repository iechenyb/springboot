 ...
 */
//@Component
//@WebFilter(filterName="casFilterSecurityInterceptor",urlPatterns="/*")
public class CasFilterSecurityInterceptor extends AbstractSecurityInterceptor implements Filter {
	...
	/*@Resource
	private CasInvocationSecurityMetadataSourceService securityMetadataSource;*/
  /*  @Resource
	private CasAccessDecisionManager casAccessDecisionManager;*/
	
	//@Resource
	public void setCasAccessDecisionManager(CasAccessDecisionManager casAccessDecisionManager) {
	...
	/*public void setCasAccessDecisionManager(CasAccessDecisionManager casAccessDecisionManager) {
		this.casAccessDecisionManager = casAccessDecisionManager;
		super.setAccessDecisionManager(casAccessDecisionManager);
	}*/
	...
	public SecurityMetadataSource obtainSecurityMetadataSource() {
		return new CasInvocationSecurityMetadataSourceService();
	}
