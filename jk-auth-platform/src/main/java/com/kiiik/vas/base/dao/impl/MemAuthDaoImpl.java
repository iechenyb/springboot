package com.kiiik.vas.base.dao.impl;
...
public class MemAuthDaoImpl implements UserAuthDao {
	...
	public Map<String, String> roleResources(String username) {
		...
		//管理员权限
		auths.put("/api/add", "ROLE_ADD");
		auths.put("/api/delete", "ROLE_DELETE");
		auths.put("/api/update", "ROLE_UPDATE");
		auths.put("/api/query", "ROLE_QUERY");
		return auths;
	}
