...
/**
 * 作者 : iechenyb<br>
 * 类描述: index 为redis 数据库序号<br>
 * 创建时间: 2018年4月19日
 */
@Component
public class RedisTempalte {
	Log logger = LogFactory.getLog(RedisTempalte.class);
	@Autowired
	...
	/**
	 * @Description:选择DB实例
	 * @author Wanglei Date: 2015-8-12 上午9:28:34
	 * @param index
	 *            实例index
	 * @version [版本号1.0.0]
	 */
	...
	/**
	 * @Description: Hash（哈希）
	 * @author Wanglei Date: 2015-8-12 上午9:30:29
	 * @param key
	 * @param field
	 * @param value
	 * @version [版本号1.0.0]
	 ...
	 * @author Wanglei Date: 2015-8-12 上午9:30:58
	 * @param key
	 * @return value
	 * @version [版本号1.0.0]
	 */
	 ...
	 * @author Wanglei Date: 2015-8-12 上午9:31:32
	 * @param key
	 * @param value
	 * @version [版本号1.0.0]
	 */
	...
	/**
	 * @Description: 批量Set
	 * @author Wanglei Date: 2015-8-12 上午9:31:58
	 * @param list
	 * @version [版本号1.0.0]
	 */
	...
	/**
	 * @Description: 根据key删除
	 * @author Wanglei Date: 2015-8-12 上午9:32:33
	 * @param key
	 * @version [版本号1.0.0]
	 */
