...
<div class="am-g">
		<div class="am-u-sm-12"><font color="blue" >{{curName}}&nbsp;&nbsp;{{curIndex}}</font><!-- <a ng-click="check()" href="javascript:void(0)">横竖屏</a> --></div>
		<div class="am-u-sm-12">
			<a ng-click="bigger()" href="javascript:void(0)">屏幕放大</a>&nbsp;&nbsp;&nbsp;&nbsp;
			<a href="javascript:void(0)" ng-click="smaller()">屏幕缩小</a>&nbsp;&nbsp;&nbsp;&nbsp;
			<a href="javascript:void(0)" ng-click="max()">屏幕最大</a>&nbsp;&nbsp;&nbsp;&nbsp;
			<a href="javascript:void(0)" ng-click="min()">屏幕最小</a>&nbsp;&nbsp;&nbsp;&nbsp;
		</div>
</div>
<div class="am-g" >
  <!-- <div class="am-u-sm-12" style="border:0px solid green;">&nbsp;</div> -->
   <!-- <div class="am-u-sm-2" style="border:0px solid green;">
    ...
    <div class="am-u-sm-12" style="border:0px solid green;margin-top:2px;">
		<iframe name="center"  id="center"  width="100%"  height="20%" src="http://player.jidiaose.com/supapi/iframe.php?v=https://v.qq.com/x/cover/fzfi0p4etjrckhh/o0026hwp2r1.html"  frameborder=0 >
		</iframe>
    </div> 
