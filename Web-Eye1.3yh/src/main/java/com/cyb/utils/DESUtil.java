...
public class DESUtil {
    ...
    public static String mcSHA1(String src){
        ...
        return org.bouncycastle.util.encoders.Hex.toHexString(sha1Byte1);
    }
    public static void main(String[] args) {
        DESUtil desObj = new DESUtil();
        String key1 = String.valueOf(System.currentTimeMillis());
        String key2 = String.valueOf(new Date().getTime());
        String key3 = "iechenyb";
        String data = "admin";
        String str = desObj.strEnc(data, key1, key2, key3);
        System.out.println(str);
        String dec = desObj.strDec(str, key1, key2, key3);
        System.out.println(dec);
        System.out.println(jdkSHA1("chsf"));
        System.out.println(jdkBase64("sfslfdk"));
        System.out.println(mcSHA1("sfdsdf"));
    }
